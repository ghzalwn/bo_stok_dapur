    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btn-submit').click(function() {
                let id = $('#form-user').find("[name='id']").val();
                const formSubmit = $('#form-user').serialize()
                $.ajax({
                    method: id == '' ? 'POST' : 'PUT',
                    url: id == '' ? "/manager/user/store" : '/manager/user/update/' + id,
                    data: formSubmit,
                    cache: false,
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (status) {
                            ...
                            $('#modal-form').find("[name='user_name']").val(data.user_name);
                        } else {
                            swal({
                                title: "Message",
                                text: message,
